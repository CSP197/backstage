...
export class CommonDatabase implements Database {
  ...
  async addEntities(
    ...
    for (const entity of request.entities) {
      ...
      entityRows.push(this.toEntityRow(request.locationId, newEntity));
  ...
  async entities(
    ...
    for (const filter of filters || []) {
      ...
      const filtersQuery = tx<DbEntitiesSearchRow>('entities_search')
        .select('entity_id')
      ...
      entitiesQuery = entitiesQuery.andWhere('id', 'in', filtersQuery);
    }
